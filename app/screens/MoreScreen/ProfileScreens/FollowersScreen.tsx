...
interface FollowersScreenProps extends AppStackScreenProps<"FollowersScreen"> {}
export const FollowersScreen: FC<FollowersScreenProps> = observer(function FollowersScreen(_props) {
  ...
  return (
    <Screen preset="scroll" contentContainerStyle={styles.container} safeAreaEdges={["top"]}>
      <TopHeader
        ...
        centerText="moreScreen.myProfile.Followers"
        customStyle={{marginTop: 12, paddingHorizontal: 16,}}
      />
      ...
      {(tabData.length != 0) ? (
        ...
        <View style={{ flex: 1, alignItems: "center", alignSelf: "center" }}>
          <EmptyScreen
            Icon="emptyFollowing"
            title="moreScreen.myProfile.followersScreen.EmptyScreentitle"
          />
        </View>
      )}
    </Screen>
