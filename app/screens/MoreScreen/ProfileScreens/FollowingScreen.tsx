...
interface FollowingScreenProps extends AppStackScreenProps<"FollowingScreen"> {}
export const FollowingScreen: FC<FollowingScreenProps> = observer(function FollowingScreen(_props) {
