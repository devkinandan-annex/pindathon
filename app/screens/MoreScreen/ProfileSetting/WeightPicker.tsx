...
const WeightPicker: React.FC<WeightPickerProps> = ({ activeNumber = 180, setHeight, onClose }) => {
  let data = [];
  ...
  <WheelPickerExpo
    ...
    <Text text="Kg" style={{position:'absolute', top:96, fontSize:18, right:Dimensions.get('screen').width /2 - 80, lineHeight:22, color:'#242627' }} />
