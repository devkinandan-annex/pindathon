...
interface ChangeEmailProps extends AppStackScreenProps<"ChangeEmail"> {}

export const ChangeEmail: FC<ChangeEmailProps> = observer(function ChangeEmail(_props) {
  ...
  return (
    ...
    >
      <TopHeader
        ...
        centerText={'moreScreen.myProfile.profileSettings.changeEmail'}

      />
      <Text tx="moreScreen.myProfile.profileSettings.changeEmailScreen.title" preset="subheading" style={$enterDetails} />
      ...
      <View style={$inputOuter}>
        <TextField
          ...
          labelTx="moreScreen.myProfile.profileSettings.changeEmailScreen.label"
